...
export default function WhatsAppButton() {
  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-6 z-[100] flex items-center justify-center w-14 h-14 bg-primary/95 backdrop-blur-sm border border-secondary text-secondary rounded-full shadow-lg hover:bg-secondary hover:text-primary hover:-translate-y-1 hover:shadow-secondary/30 transition-all duration-300 cursor-pointer"
